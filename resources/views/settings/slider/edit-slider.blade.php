        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div class="max-w-xl">
                    ...
                    <form method="post" action="{{ url('pengaturan/halaman-awal/slider/save') }}" enctype="multipart/form-data"
                        ...
                        <div class="mb-5">
                            ...
                            <input type="file" name="gambar" id="gambarInput" accept="image/*" class="mt-2">
                        </div>
