        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div class="max-w-xl">
                    ...
                    <form method="post" action="{{ url('pengaturan/halaman-awal/video/save') }}" enctype="multipart/form-data"
                        ...
                        <!-- Input File -->
                        <div class="mb-5">
                            <label class="block text-sm font-medium text-gray-700">Ganti Thumbnail <span class="text-red-500">*Gunakan svg/png untuk icon transparan</span></label>
                        ...
                        <div class="mb-5">
                            <label for="url"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Url Video</label>
                            <input type="text" id="url" name="url"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="{{ $ds->url }}" required />
                        </div>
