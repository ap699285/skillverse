@section('title', 'Pengaturan Course')
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div class="max-w-xl">
                    ...
                    <form method="post" action="{{ url('pengaturan/halaman-awal/counter/save') }}" enctype="multipart/form-data"
                        ...
                        <div class="mb-5">
                            <label for="sub_judul"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sub Judul</label>
                            <input type="text" id="sub_judul" name="sub_judul"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="{{ $ds->sub_judul }}" required />
                        </div>

                        <div class="mb-5">
                            <label for="jumlah_kursi"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah Kursi</label>
                            <input type="text" id="jumlah_kursi" name="jumlah_kursi"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="{{ $ds->jumlah_kursi }}" required />
                        </div>

                        <div class="mb-5">
                            <label for="lama_waktu"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lama Waktu</label>
                            <input type="text" id="lama_waktu" name="lama_waktu"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="{{ $ds->lama_waktu }}" required />
                        </div>

                        <div class="mb-5">
                            <label for="lesson"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mata Pelajaran</label>
                            <input type="text" id="lesson" name="lesson"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="{{ $ds->lesson }}" required />
                        </div>
