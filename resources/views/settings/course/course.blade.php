                ...
                <table class="min-w-full border border-gray-300 divide-y divide-gray-200 rounded-lg shadow-sm">
                    <thead class="bg-gray-100 text-left text-sm font-semibold text-gray-500">
                        <tr>
                            ...
                            <th class="px-4 py-3">Lama Waktu</th>
                    ...
                    <tbody class="divide-y divide-gray-200 text-sm text-gray-800">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2">{{ $post->jumlah_kursi }}</td>
                            <td class="px-4 py-2">{{ $post->lama_waktu }}</td>
                            <td class="px-4 py-2">{{ $post->lesson }}</td>
                            <td class="px-4 py-2">{{ $post->keterangan }}</td>
                            <td class="px-4 py-2 align-middle">
                                <a href="{{ url('pengaturan/halaman-awal/course?edit=true&id='.$post->id) }}"
