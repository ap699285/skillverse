        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                    <div class="course-img">
                        ...
                        <img src="{{ asset('img/course/01.jpg') }}" alt="">
                        <a href="course-single.html" class="btn"><i class="fa-solid fa-link"></i></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
                            <span class="course-meta-left"><i class="fa-solid fa-book"></i> 10 Lessons</span>
                        ...
                        <div class="course-bottom">
                            <div class="course-bottom-left">
                                <span><i class="fa-solid fa-users"></i>75 Seats</span>
                                <span><i class="fa-solid fa-clock"></i>04 Years</span>
                            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="course-item wow fadeInUp" data-wow-delay=".50s">
                    <div class="course-img">
                        ...
                        <img src="{{ asset('img/course/02.jpg') }}" alt="">
                        <a href="course-single.html" class="btn"><i class="fa-solid fa-link"></i></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="course-item wow fadeInUp" data-wow-delay=".75s">
                    <div class="course-img">
                        ...
                        <img src="{{ asset('img/course/03.jpg') }}" alt="">
                        <a href="course-single.html" class="btn"><i class="fa-solid fa-link"></i></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                    <div class="course-img">
                        <span class="course-tag"><i class="far fa-bookmark"></i> Science</span>
                        <img src="{{ asset('img/course/04.jpg') }}" alt="">
                        <a href="course-single.html" class="btn"><i class="fa-solid fa-link"></i></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="course-item wow fadeInUp" data-wow-delay=".50s">
                    <div class="course-img">
                        ...
                        <img src="{{ asset('img/course/05.jpg') }}" alt="">
                        <a href="course-single.html" class="btn"><i class="fa-solid fa-link"></i></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="course-item wow fadeInUp" data-wow-delay=".75s">
                    <div class="course-img">
                        ...
                        <img src="{{ asset('img/course/06.jpg') }}" alt="">
                        <a href="course-single.html" class="btn"><i class="fa-solid fa-link"></i></a>
                    </div>
                    <div class="course-content">
                        <div class="course-meta">
