    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mx-auto">
                <div class="site-heading text-center">
                    <span class="site-title-tagline"><i class="fa-solid fa-book-open"></i> Testimonials</span>
        ...
        <div class="testimonial-slider owl-carousel owl-theme">
            <div class="testimonial-item">
                ...
                <div class="testimonial-content">
                    <div class="testimonial-author-img">
                        <img src="{{ asset('img/testimonial/01.jpg') }}" alt="">
                    </div>
            ...
            <div class="testimonial-item">
                ...
                <div class="testimonial-content">
                    <div class="testimonial-author-img">
                        <img src="{{ asset('img/testimonial/02.jpg') }}" alt="">
                    </div>
                    <div class="testimonial-author-info">
                        <h4>Richard Lock</h4>
                        <p>Student</p>
            ...
            <div class="testimonial-item">
                ...
                <div class="testimonial-content">
                    <div class="testimonial-author-img">
                        <img src="{{ asset('img/testimonial/03.jpg') }}" alt="">
                    </div>
                    <div class="testimonial-author-info">
                        <h4>Randal Grand</h4>
                        <p>Student</p>
            ...
            <div class="testimonial-item">
                ...
                <div class="testimonial-content">
                    <div class="testimonial-author-img">
                        <img src="{{ asset('img/testimonial/04.jpg') }}" alt="">
                    </div>
                    <div class="testimonial-author-info">
                        <h4>Edward Miles</h4>
                        <p>Student</p>
            ...
            <div class="testimonial-item">
                ...
                <div class="testimonial-content">
                    <div class="testimonial-author-img">
                        <img src="{{ asset('img/testimonial/05.jpg') }}" alt="">
                    </div>
                    <div class="testimonial-author-info">
                        <h4>Ninal Gordon</h4>
                        <p>Student</p>
